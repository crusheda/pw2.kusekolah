         ...
         <div class="ui inline dropdown">
          ...
          <div class="ui hidden transition information">
            <h1 class="ui inverted centered header">
              ...
              <p class="ui centered lead">Mengelola Data Siswa</p>
            <br>
          </div>
        </div>  
      </div>
  ...
  <br>
	...
	<?php
        ...
        <div class="scrollmenu">
              ...
              <td>  
                <center><button class="ui icon button" onclick="window.location.href='editsiswa.php?npsn= <?php echo "{$row['npsn']}"?>'">
                  <i class="edit icon" ></i>
                </button></center>
              </td> 
              <td>  
                <center><button class="ui icon button" onclick="window.location.href='hapussiswa.php?npsn= <?php echo "{$row['npsn']}"?>'">
