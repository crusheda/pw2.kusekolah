  ...
  <br>
	...
	<?php
        ...
        <div class="scrollmenu">
              ...
              <td>  
                <center><button class="ui icon button" onclick="window.location.href='edit_aset_bangunan.php?npsn= <?php echo "{$row['npsn']}"?>'">
                  <i class="edit icon" ></i>
                </button></center>
              </td> 
              <td>  
                <center><button class="ui icon button" onclick="window.location.href='hapus_aset_bangunan.php?npsn= <?php echo "{$row['npsn']}"?>'">
