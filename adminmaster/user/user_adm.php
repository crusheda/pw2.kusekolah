        ...
        <div class="ui secondary pointing menu">
          ...
          <div class="ui hidden transition information">
            <h1 class="ui inverted centered header">
              ...
              <p class="ui centered lead">Mengelola Data User</p>
            <br>
          </div>
        </div>  
      </div>
  ...
  <br>
	...
	<?php
        ...
        <div class="scrollmenu">
              ...
              <td>  
                <center><button class="ui icon button" onclick="window.location.href='edit_user.php?id= <?php echo "{$row['id']}"?>'">
                  <i class="edit icon" ></i>
                </button></center>
              </td> 
              <td>  
                <center><button class="ui icon button" onclick="window.location.href='hapus_user.php?id= <?php echo "{$row['id']}"?>'">
